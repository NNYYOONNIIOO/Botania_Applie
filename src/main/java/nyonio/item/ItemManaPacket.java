...
public class ItemManaPacket extends Item {
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        if (!isDisplayOnly(stack)) {
            tooltip.add("\u00a77" + I18n.translateToLocal("botania_applie.tooltip.shift_for_details"));
            if (Keyboard.isKeyDown(Keyboard.KEY_LSHIFT) || Keyboard.isKeyDown(Keyboard.KEY_RSHIFT)) {
                long mana = getMana(stack);
                tooltip.add(I18n.translateToLocalFormatted("botania_applie.tooltip.stored_mana", mana));
            }
        }
    }
    ...
    private String getManaName() {
        return "\u00a76" + I18n.translateToLocal("botania_applie.mana_packet.display_name");
    }
}